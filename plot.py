...
plot_high_quality_image(ct_img, output_filename='ct_img.png')
plot_high_quality_image(ct_seg_mask, output_filename='ct_seg_mask.png', cmap='viridis')
plot_high_quality_image(ct_img, mask_data=ct_seg_mask, is_combined=True, output_filename='ct_img_with_seg_mask.png',
                        custom_cmap=custom_cmap, norm=norm)
plot_high_quality_image(mri_img, output_filename='mri_img.png')
